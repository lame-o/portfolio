...
export default function Home() {
  ...
  return (
    <main className="min-h-screen antialiased">
              ...
              <div className="flex flex-col gap-3">
                {['About', 'Contact'].map((item) => (
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="justify-start rounded-md transition-all duration-300 hover:bg-primary hover:text-primary-foreground"
                    onClick={() => {
                      const element = document.getElementById(item.toLowerCase().replace(' ', '-'));
                      if (element) {
                        element.scrollIntoView({ behavior: 'smooth' });
      ...
      {/* Hero Section: keep only mountain imagery */}
          ...
          >
            ...
            >
              <Button
                ...
                variant="ghost"
                size="sm"
                className="rounded-full hover:bg-transparent hover:text-white text-white/90 transition-all duration-300 px-4"
              >
                <a href="mailto:liamhdwight@gmail.com">
                  Email
                </a>
              </Button>
            </motion.div>
